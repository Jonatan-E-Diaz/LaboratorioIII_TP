...
public class Prueba {
    ...
    public static void main(String[] args) {
        ...
        Cliente cliente1 = new Cliente(null, "Juan", "Pérez", 12345678, "Calle Falsa 123",
                LocalDate.of(1990, 5, 10), "1234567890", "juan@example.com",
                TipoPersona.PERSONA_FISICA, "Banco X");
        clienteLista.agregarCliente(cliente1);
        
        Cliente cliente2 = new Cliente(null, "María", "Gómez", 23456789, "Avenida Siempreviva 456",
                        LocalDate.of(1995, 3, 15), "0987654321", "maria@example.com",
                        TipoPersona.PERSONA_FISICA, "Banco Y");
